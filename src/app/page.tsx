...
export default function Home() {
  return <main>
    <nav className="nav shell"><a className="brand" href="#top" aria-label="Kaliber Kitchen home"><span className="brandMark">K</span><span>KALIBER KITCHEN</span></a><div className="navLinks"><a href="#kitchen">Kitchen</a><a href="#meals">Meals</a><a href="#shopping">Shop</a></div></nav>
